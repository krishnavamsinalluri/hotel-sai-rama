      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="relative aspect-4/3 rounded-2xl overflow-hidden shadow-lg border-2 border-white bg-gray-100">
              <Image
                src="/images/exterior/hotel-sai-rama-entrance.webp"
                alt="Hotel Sai Rama Main Entrance and Canopy"
                fill
                sizes="(max-width: 1024px) 100vw, 25vw"
                className="object-cover"
              />
              <div className="absolute bottom-2 left-2 bg-black/70 text-white text-[10px] px-2.5 py-1 rounded-md font-bold">
                Main Entrance
              </div>
            </div>
            <div className="relative aspect-4/3 rounded-2xl overflow-hidden shadow-lg border-2 border-white bg-gray-100 sm:mt-6">
              <Image
                src="/images/reception/hotel-sai-rama-reception.webp"
                alt="Hotel Sai Rama Reception Desk"
                fill
